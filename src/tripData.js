...
export const TRIP_DATA = {
  ...
  aidenStatus: {
    '2026-05-11': 'All together', '2026-05-12': 'Grandparents (Small Worlds am)',
    '2026-05-13': 'Grandparents (DisneySea)', '2026-05-14': 'All together',
    '2026-05-15': 'All together', '2026-05-16': 'Split — T+M am, all pm',
    '2026-05-17': 'All together am, Grandparents pm (Small Worlds)', '2026-05-18': 'All together',
  ...
  days: [
    ...
    { id: 'd2', date: '2026-05-12', title: 'Free · Small Worlds', titleJp: '自由時間', summary: 'Easy second day. Split morning — C+D+Aiden to Small Worlds, T+M free. Aiden settles in.',
      pinned: [], wishes: [], ideas: [], rating: 0, diary: '', dayBagExtras: [], dayBagDone: {},
      items: [
        { id: uid(), type: 'activity', time: '09:30', title: 'C+D+Aiden: Small Worlds Tokyo', owner: 'CD', mapUrl: 'https://www.google.com/maps/search/?api=1&query=Small+Worlds+Tokyo+Ariake', note: 'Indoor, calm, ~3-4 hrs. Stroller-friendly. Address: 1-3-33 Ariake, Koto City.', places: [] },
        { id: uid(), type: 'activity', time: '09:30', title: 'T+M: Free morning', owner: 'TM', status: 'tbd', note: 'Research/explore Shinagawa area. Or rest.', places: [] },
        { id: uid(), type: 'restaurant', time: '12:30', title: 'Lunches — TBD', status: 'tbd', owner: 'EVERYONE', places: [] },
        { id: uid(), type: 'note', time: '14:00', title: 'Together afternoon — TBD', status: 'tbd', owner: 'EVERYONE', note: 'Easy activity near hotel. Play by ear based on how Aiden is doing.', places: [] },
        { id: uid(), type: 'note', time: '18:00', title: 'Early dinner + Aiden bedtime', owner: 'EVERYONE', places: [] },
      ],
    },
    ...
    { id: 'd7', date: '2026-05-17', title: 'Asakusa · Toyosu · Luggage', titleJp: '浅草 · 豊洲 · 荷物転送', summary: 'Sensō-ji morning, river cruise to Toyosu, lunch + foot bath. Afternoon split. Evening luggage forwarding to Osaka.',
      pinned: [], wishes: [], ideas: [], rating: 0, diary: '', dayBagExtras: [], dayBagDone: {},
      items: [
        { id: uid(), type: 'place', time: '09:00', title: 'Sensō-ji + Asakusa backstreets', owner: 'EVERYONE', mapUrl: 'https://www.google.com/maps/search/?api=1&query=Senso-ji+Temple+Asakusa', note: 'Explore the temple and surrounding Asakusa backstreets. Address: 2-chōme-3-1 Asakusa, Taito City. Day 7 = crowds should be manageable mid-trip.', places: [] },
        ...
        { id: uid(), type: 'activity', time: '14:45', title: 'T+M: Free afternoon', owner: 'TM', status: 'tbd', note: 'Akihabara, Shibuya, or just wander.', places: [] },
        { id: uid(), type: 'document', time: '18:00', title: '⚠️ LUGGAGE FORWARDING — pack 5 cases', owner: 'EVERYONE', note: 'Hotel arranges Yamato. "Sales Office Pickup". To Yamato Nippombashihigashi. Last night in Tokyo — pack tonight for tomorrow morning departure.', places: [] },
      ],
    },
  ...
  bookings: [
    ...
    { id: 'b_cruise', title: 'Tokyo Cruise — Hotaluna/Himiko boat', detail: 'Asakusa → Toyosu (Asakusa-Odaiba Direct Line)', date: '2026-05-17', status: 'tbd', notes: 'Book via Tokyo Cruise website. Departs Asakusa Pier 11:30. ~45 min. Aiden naps on the boat.', files: [] },
